...
begin
  ...
  loop
    ...
    values (
      p_stock_item_id, p_stock_item_id, r.id, 'saida', v_take, v_unidade,
...
revoke all on function public.consume_stock_fifo(uuid, numeric, text, text) from public;
grant execute on function public.consume_stock_fifo(uuid, numeric, text, text) to authenticated;
